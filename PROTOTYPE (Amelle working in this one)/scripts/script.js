SVG.on(document, 'DOMContentLoaded', function() {
  ...
  let hexobjA = new HexObj(125, 93, 0, 0, draw, "bla bla 1");
  let hexobjB = new HexObj(50, 50, 0, 0, draw, "bla bla 2");
  hexobjA.display();
  // hexobjA.appendText();
  ...
  function newOnClick() {
    ...
    let newHex = new HexObj(tileX, tileY, huevalue, huevalue2, draw, inputText);
    hexObjs.push(newHex);
    newHex.display();
